        ...
        success:function(result){
            if(200 != result.status){
               ...
               $.each(goodsList,function (index,goods) {
                   ...
                   var option = "<option value = '" + goodsId + "'>" + goodsName + "</option>"
                   html += option;
               })
               $("#goodsName").html(html);
            }
    ...
    $.ajax({
        ...
        success:function(result){
            ...
            if(200 != result.status){
                ...
                $("#descriptor").val(result.data.descriptor);
...
function save(){
    ...
    var param = {
        ...
        descriptor : $("#descriptor").val() != "" ? $("#descriptor").val() : null
    }
