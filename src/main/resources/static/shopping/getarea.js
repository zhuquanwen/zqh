...
{
	$("#"+input+"_country").html("<option>-区/县-</option>");
	$.ajax({
		url : "member.php?a=getarea&datagroup=area&level=1&areaval="+val,
		type:'get',
		dataType:'html',
...
{
	$.ajax({
		url : "member.php?a=getarea&datagroup=area&level=2&areaval="+val,
		type:'get',
		dataType:'html',
		success:function(data){
